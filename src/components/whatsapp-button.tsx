...
export function WhatsAppButton({ number, message }: WhatsAppButtonProps) {
    const defaultMsg = "Hola! Me gustaría más información sobre sus productos.";
    ...
    return (
        ...
        >
            ...
            <span
                className="hidden lg:block bg-stone-900 text-stone-100 text-xs font-medium px-3 py-1.5 rounded-full shadow-lg
            ...
            <div className="relative">
                ...
                <div
                    className="relative w-14 h-14 bg-stone-900 hover:bg-amber-900 text-white rounded-full
                               flex items-center justify-center shadow-xl shadow-stone-900/30
